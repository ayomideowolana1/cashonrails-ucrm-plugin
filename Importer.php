...
namespace CashonRails;

use CashonRails\CashonRails\Cashonrails;
use CashonRails\Facade\UcrmFacade;

use CashonRails\Service\Logger;
use CashonRails\Service\OptionsManager;
...
class Importer
{
    ...
    public function __construct(Cashonrails $cashOnRails, OptionsManager $optionsManager, Logger $logger, UcrmFacade $ucrmFacade)
    {
        $this->cashOnRails = $cashOnRails;
    ...
    public function import(): void
    {
        ...
        try {
            ...
            $transactions = $this->cashOnRails->getTransactions(
                $optionsData->token,
                $startDate,
                $endDate,
