...
namespace CashonRails\CashonRails;

use CashonRails\Service\CashonrailsCurlExecutor;
use CashonRails\Service\Logger;

class Cashonrails
{
    /**
     * @var CashonrailsCurlExecutor
     */
    ...
    public function __construct(CashonrailsCurlExecutor $fioCurlExecutor, Logger $logger)
    {
    ...
    /**
     * @throws \Exception
     * @throws \CashonRails\Exception\CurlException
     */
